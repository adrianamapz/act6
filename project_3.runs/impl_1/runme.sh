...
HD_PWD='C:/Users/Adriana Martinez/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_768x576.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_768x576.tcl -notrace
