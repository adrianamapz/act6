...
HD_PWD='C:/Users/Adriana Martinez/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_768x576.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_768x576.tcl
